  ...
  renderButton() {
    return (
      <TouchableOpacity style={styles.btn} onPress={this.onPressButton}>
        <Text style={styles.btnText}>proceed to checkout now</Text>
      </TouchableOpacity>
    );
  }
  ...
  render() {
    return (
      <View style={styles.panel}>
        ...
        {this.renderTextfield({ name: "phone", label: "Mobile phone number", keyboard: "phone-pad" })}
        {this.renderTextfield({ name: "email", label: "Email", keyboard: "email-address" })}
        {this.renderTextfield({ name: "street", label: "Address" })}
        {this.renderButton()}
      </View>
    );
  }
